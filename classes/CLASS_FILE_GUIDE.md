...
- **`preview`** is the "Next Week's Reading" section â€” same paragraph-range system as `mtb`. Always include a preview — infer the next ~1,000–2,000 words of MTB if KK doesn’t explicitly assign reading.
